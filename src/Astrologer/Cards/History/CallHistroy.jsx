    ...
    return (
      <View
        ...
        <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
          <View>
            <Text
              style={{fontSize: 16, fontWeight: '500', color: Colors.black8}}>
              Order Id: <Text> {item.orderId}</Text>
            </Text>
            <Text
              style={{fontSize: 16, fontWeight: '500', color: Colors.black8}}>
              Boost Id: <Text>{item.boostId}</Text>
            </Text>
          </View>
        ...
        <Text style={{fontSize: 16, fontWeight: '500', color: Colors.black8}}>
          Gender: <Text style={{fontWeight: '400'}}>{item.gender}</Text>
        </Text>
        <Text style={{fontSize: 16, fontWeight: '500', color: Colors.black8}}>
          Dob:{' '}
        ...
        <View style={{marginTop: 10}}>
          <Text style={{fontSize: 15, fontWeight: '500', color: Colors.black7}}>
            Order Time:{' '}
